...
/**
 * AI Tools: the site's own tools on one page, a company, a person, a
 * website. Each card says what it checks, what it costs and where to start.
 */
...
const SCANS: readonly Scan[] = [
  {
    ...
    input: "One company website",
    gets: ["Five AI models, each searching the web live", "A PDF report by email in about five minutes", "Built for checking a new partner or supplier"],
    ...
    <>
      <section className="bg-background">
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
          <p className="mb-4 text-base font-bold uppercase tracking-wider text-accent">AI Tools</p>
          <h1 className="max-w-4xl text-5xl font-bold leading-[0.95] tracking-[-0.045em] text-white sm:text-6xl lg:text-7xl">
            What AI tells people about <span className="text-accent">a company, a person or a website.</span>
          </h1>
          <p className="mt-6 max-w-2xl text-xl leading-relaxed text-white/80">
            Before a meeting, a purchase or a contract, people now ask an AI assistant first. Each tool shows what it tells
      ...
      <section className="bg-accent">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <p className="max-w-4xl text-2xl font-bold leading-snug text-black sm:text-3xl">
            Every tool asks real AI models through their APIs with web search on, and every report shows what each model
