...
const latestNews = [
  {
    ...
    href: "/solo/ai-agents-market",
  },
  {
    title: "OpenAI Cuts API Prices by 40% — What It Means for Startups",
    excerpt: "OpenAI's latest pricing changes make it 40% cheaper to build AI products...",
    category: "Startups",
    badgeColor: "bg-purple-500 text-white",
    time: "4h ago",
    image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=600&q=80",
    href: "/startups/openai-pricing",
  },
  {
    title: "Marketing Agency Saves 40% with AI Automation",
    excerpt: "A 15-person digital marketing agency replaced manual processes with AI tools...",
    category: "B2B",
    badgeColor: "bg-blue-500 text-white",
    time: "6h ago",
    image: "https://images.unsplash.com/photo-1553877522-43269d4ea984?w=600&q=80",
    href: "/b2b/marketing-agency-ai",
  },
  {
    title: "5 AI Tools That Pay for Themselves in Week One",
    excerpt: "We tested 30+ AI tools and found 5 that generate positive ROI within 7 days...",
    category: "Tools",
    badgeColor: "bg-emerald-500 text-white",
    time: "8h ago",
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&q=80",
    href: "/tools/ai-tools-positive-roi",
  },
  {
    title: "From Teacher to $8K/Month AI Freelancer in 6 Months",
    excerpt: "Sarah left her teaching job and now earns $8,200/month writing AI-powered content...",
    category: "Solo",
    badgeColor: "bg-amber-500 text-black",
    time: "12h ago",
  ...
  },
  {
    ...
    excerpt: "Anthropic's latest funding round values the company at $61.5 billion...",
    category: "Startups",
    badgeColor: "bg-purple-500 text-white",
    time: "1d ago",
    image: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=600&q=80",
    href: "/startups/anthropic-funding",
  },
];
