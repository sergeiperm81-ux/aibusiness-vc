...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/ai-tools`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${baseUrl}/professional-scan`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/company-scan`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
