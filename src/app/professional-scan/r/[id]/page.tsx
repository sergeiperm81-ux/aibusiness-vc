...
export default async function PreviewPage({
  ...
  if (preview.kind === "company") {
    return (
      <Message title="This preview is for AI Company Scan">
        <Link href={`/company-scan/r/${preview.id}`} className="font-bold text-black underline decoration-accent decoration-4 underline-offset-4">
          Open it there
        </Link>
        .
      </Message>
          ...
          <ul className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <li className="flex flex-wrap items-center gap-4 rounded-2xl bg-black px-6 py-4 md:col-span-2 lg:col-span-3">
              ...
              <p className="text-lg font-bold text-white">
                ...
                or AI Company Scans, yours to give away to friends, family and partners.
              </p>
            </li>
          </ul>
          ...
          <div className="mt-6">
            {closedReason ? (
              ...
              <div className="grid grid-cols-1 items-center gap-4 lg:grid-cols-2">
                <CheckoutButton href={`/api/professional-scan/checkout?preview=${encodeURIComponent(preview.id)}`} kind="person">
