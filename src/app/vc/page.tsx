      ...
      <section className="bg-background">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">
            AI Venture Capital — <span className="text-accent">How Capital Moves</span>
          </h1>
          <p className="text-sm text-white/70 max-w-2xl">
            Funds, accelerators, and funding rounds — $150B flowed into AI startups in 2025.
            Who&apos;s investing, who&apos;s raising, and how the returns actually look.
          </p>
        </div>
      </section>

      <SectionArticleExplorer articles={articles} section="vc" totalLabel="articles" />
    </>
  );
}
