...
|---|---|---|
| Preparation | 4-6 weeks | Deck, financial model, data room |
| Warm intros | 2-3 weeks | Introductions to 30-50 target investors |
| First meetings | 3-4 weeks | 30-minute calls, feeling out mutual fit |
| Deep dives | 2-3 weeks | Partner meetings, demos, reference checks |
| Term sheets | 1-2 weeks | Negotiate with 1-3 interested firms |
| Close | 2-4 weeks | Legal docs, wire |
| **Total** | **3-5 months** | |
