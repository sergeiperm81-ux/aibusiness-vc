...
This is different from the pattern covered in [ElevenLabs' $500M ARR signal](/vc/elevenlabs-growth-round-vc-signal-2026). ElevenLabs can point to recurring revenue, enterprise adoption, and strategic investors around a product already being bought at scale. Isomorphic can point to scientific pedigree, pharma partnerships, platform ambition, and a huge market, but the clinical proof curve is still ahead.
...
This also ties back to [AI startup valuations in 2025-2026](/vc/ai-startup-valuations-2025-2026). Investors are still paying premiums for AI, but the premium is not automatic. It attaches to companies that can plausibly own a valuable layer of the new economy. Isomorphic's claim is that AI-native drug design can become one of those layers.
