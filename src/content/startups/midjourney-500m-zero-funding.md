...
- [OpenAI's $13B ARR: The Fastest-Growing Company in History](/startups/openai-13b-arr) — the opposite end of the spectrum: the most-funded AI company and its revenue machine.
- [Cursor Hit $9B Valuation](/startups/cursor-9b-valuation) — another AI startup with remarkable capital efficiency and explosive growth.
- [How to Make Money with Claude AI](/solo/make-money-with-claude-ai) — if Midjourney inspired you, here are practical ways to build income with AI tools.
- [AI Kills Middle-Class Jobs — or Does It?](/society/ai-kills-middle-class-jobs) — the workforce implications of companies that do more with fewer people.
