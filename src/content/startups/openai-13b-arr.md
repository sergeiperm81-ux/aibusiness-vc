...
Netflix took twenty-five years to reach $13 billion in annual revenue. Salesforce took twenty. Google took nine. Facebook took ten. OpenAI did it in roughly two years after launching ChatGPT. And by the time you read this, that number has already climbed past $25 billion on an annualized basis, and it is no longer the biggest on the board, as our [AI company revenue data](/startups/ai-revenue-leaderboard) shows. No company in the history of technology has ever grown revenue this fast, and the trajectory suggests we are still watching the early innings of something unprecedented.
...
- [Midjourney: $500M Revenue, Zero Funding, 40 Employees](/startups/midjourney-500m-zero-funding), the polar opposite model: the most profitable AI company raised zero dollars.
- [Klarna AI Replaces 700 Agents](/b2b/klarna-ai-replaces-700-agents), what happens when a company actually deploys AI at scale inside its operations.
- [How to Make Money with Claude AI](/solo/make-money-with-claude-ai), practical income opportunities built on top of the AI ecosystem OpenAI helped create.
- [AI Kills Middle-Class Jobs: or Does It?](/society/ai-kills-middle-class-jobs), the workforce implications of AI adoption at this speed and scale.
