...
Corporate card for startups and enterprises. AI handles expense policy enforcement, receipt matching, and spend analysis. Competes head-to-head with Ramp for the AI-powered corporate finance market.

## AI-Native Finance Startups

### Sardine ($645M Valuation)
AI fraud and compliance platform for banks and fintechs. Looks at device signals, behavioral biometrics, and transaction patterns to stop fraud in real-time.

### Alloy ($1.55B Valuation)
AI-powered identity verification and compliance automation. Banks use Alloy to automate KYC (Know Your Customer) checks that used to eat up hours of manual review.

### Socure ($4.5B Valuation)
AI identity verification that cuts fraud while making onboarding faster. Their AI verifies identities with 99% accuracy in under 2 seconds.

### Upstart ($3B+ Market Cap)
AI lending platform that uses machine learning instead of FICO scores to judge creditworthiness. They say they approve 27% more borrowers at 16% lower APR than traditional models.
...
- AI financial planning (a personal CFO in your pocket)
