...
# Anthropic's Revenue Rocket: From $5B ARR to a $965B Valuation
...
When this story first broke, Anthropic had just crossed **$5 billion in annualized revenue**, roughly $417 million a month as of mid-2025, and was projecting $9 billion by year's end. That alone was remarkable. But here's where it went: by mid-2026, Anthropic's revenue run-rate had exploded toward **$47 billion**, a figure we track against every other lab on the [AI revenue leaderboard](/startups/ai-revenue-leaderboard), the company closed a funding round at a **$965 billion valuation** that vaulted it past OpenAI, and it filed confidentially for an IPO. In about a year, the numbers didn't just grow, they changed orders of magnitude.
...
**If you're building a product**, Claude's API is becoming essential infrastructure, and building on it is a solid bet, that 300,000-customer ecosystem is full of proven demand. If you want concrete ways in, start with [how to make money with Claude AI](/solo/make-money-with-claude-ai) or the broader [AI SaaS ideas for solo developers in 2026](/solo/ai-saas-ideas-2026). The tools to build on top of this are cheaper and better than they've ever been.

**If you're job-hunting or building a career**, Anthropic went from 500 to well over 1,200 employees and keeps hiring, and the whole sector is bidding up anyone with real AI skills. I track exactly where that pay is concentrated in [the highest-paying AI jobs of 2026](/learn/highest-paying-ai-jobs-2026).

**If you're an investor**, the lesson is about multiples and durability. At a $965B valuation on a ~$47B run-rate, Anthropic trades around 20x revenue, aggressive, but cheaper than it looks once you account for a growth rate this steep. To judge whether that's sane or stretched, I'd read [how VCs actually price AI companies in 2026](/vc/ai-startup-valuations-2025-2026) alongside [the wider trillion-dollar AI race](/startups/ai-trillion-dollar-race-may-2026).

## The honest take

Anthropic's run from $5B ARR to a $965B valuation proves there's room for more than one giant winner in the model race, the market is large enough for OpenAI ([now well past $13B ARR](/startups/openai-13b-arr)) and Anthropic to both generate staggering revenue at the same time. For anyone building with AI, that competition is the best news there is: it means better models, falling prices, and a healthier ecosystem every quarter.
...
- [Anthropic Leapfrogs OpenAI to a $900B+ Valuation](/vc/anthropic-30b-raise-900b-valuation-2026), the funding round and the first profitable quarter behind it
- [The $3 Trillion AI IPO Race: SpaceX, Anthropic, OpenAI](/vc/ai-ipo-race-2026-spacex-openai-anthropic), where this all goes public
- [OpenAI Hits $13B ARR](/startups/openai-13b-arr), the rival running the same race
- [How to Make Money with Claude AI](/solo/make-money-with-claude-ai), turning this infrastructure into your own revenue
