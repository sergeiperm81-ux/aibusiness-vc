...
| Function | Tool | What It Does | Price |
|----------|------|-------------|-------|
| Lead scoring | HubSpot AI, Salesforce Einstein | Predicts which leads will convert | Included in CRM |
| Email outreach | Apollo, Instantly, Lemlist | AI-personalized cold email at scale | $49-99/mo |
| Meeting scheduling | Calendly, Chili Piper | Auto-qualifies and books meetings | $15-150/mo |
| Call intelligence | Gong, Chorus | AI analyzes sales calls for coaching | $100+/user/mo |
| CRM automation | HubSpot, Salesforce | Auto-logs activities, updates deals | $45-150/user/mo |
| Proposal generation | PandaDoc, Proposify | AI-drafted proposals and quotes | $19-65/mo |
