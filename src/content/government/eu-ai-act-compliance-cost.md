...
1. **Risk management system** — Document all risks and mitigations
2. **Data governance** — Prove your training data is relevant, representative, and free from errors
3. **Technical documentation** — Detailed description of the system, its purpose, and performance
4. **Record-keeping** — Log all system operations and decisions
...
7. **Accuracy, robustness, cybersecurity** — System must meet quality standards
8. **Conformity assessment** — Third-party or self-assessment depending on use case
...
1. **Access the EU market** (500 million consumers, $18 trillion GDP) while competitors are blocked
