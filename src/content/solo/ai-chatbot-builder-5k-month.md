...
**Setup fee:** $800 per practice. Covers building the chatbot, training it on the practice's FAQs, services, insurance policies, and scheduling system. Takes David 3-4 hours per setup.

**Monthly retainer:** $200 per practice. Covers ongoing maintenance, answer updates, performance monitoring, and minor tweaks. Takes about 30 minutes per client per month.

**The math:**
- 15 clients × $200/month = $3,000 recurring
- 2-3 new setups per month × $800 = $1,600-2,400
...
- Emergency triage (routes urgent cases to staff)

## The Tech Stack

| Tool | Cost | Purpose |
|------|------|---------|
| Tidio or Botpress | $0-29/mo per client | Chatbot platform |
| ChatGPT API | ~$5/mo per client | AI responses |
| Calendly or practice software | Varies | Appointment booking |
| Zapier | $20/mo total | Integrations |
| **Total per client** | **~$30-50/mo** | |

At $200/month per client with $30-50 in costs, David's gross margin is 75-85% per client.

## How He Got His First 15 Clients
