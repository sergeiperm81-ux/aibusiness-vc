...
This is the cost and margin guide, not the list of offers. If you have not chosen what the customer will pay for, start with the [seven ways to make money with Claude](/solo/make-money-with-claude-ai) and come back once you need to price delivery.
...
**How much does Claude cost for a one-person AI business?**
$20/month for Claude Pro covers most service work; heavy Claude Code users pay $100-200/month for Max tiers. API usage for a typical automation client runs $45-90/month. Against a single client paying $1,000-5,000/month, tooling is a rounding error.

**Should a solo operator use the subscription or the API?**
Subscription for your own working sessions; API when you deliver automated systems that run without you. Most solo businesses end up with both, and both together usually stay under $250/month.

**What margins do AI services actually have?**
Commonly 85-95%. When a $1,500/month agent costs $50-90 in API fees to run, the margin lives in your expertise, not in the compute.
