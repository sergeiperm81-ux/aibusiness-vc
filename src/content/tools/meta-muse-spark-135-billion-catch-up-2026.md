...
keywords: ["Meta Muse Spark", "Meta AI capex 2026", "Alexandr Wang Superintelligence Labs", "Meta vs OpenAI", "Meta $135 billion AI", "Muse Spark vs GPT"]
---
...
| Model | Company | Positioning |
|---|---|---|
| Muse Spark | Meta | New flagship — "competitive performance at lower compute cost," likely open-weight |
| [Claude Fable 5](/tools/claude-fable-5-mythos-5-launch-2026) | Anthropic | Frontier leader on coding/agents (currently government-restricted) |
| [Gemini 3.5 Flash](/tools/google-io-2026-gemini-35-flash-price-war) | Google | Price-war weapon, 1B+ users via Search |
| GPT-5.5 | OpenAI | Consumer king, ~900M weekly users |
...
| Where Meta's billions flow | Who gets paid |
|---|---|
| AI chips (GPUs) | [NVIDIA — already posting $78B+ quarters](/startups/nvidia-q1-fy27-earnings-78-billion-test-2026) |
| Data centers & construction | Builders, real estate, cooling |
| Electricity | [Utilities — driving deals like the $67B NextEra-Dominion merger](/government/nextera-dominion-67-billion-ai-power-merger-2026) |
| Talent | $14B for Wang's team; multi-million-dollar researcher packages |

This is why I keep telling readers that the surest money in AI isn't always the flashy model — it's the picks and shovels underneath. When Meta commits $135 billion, NVIDIA sells more chips, utilities sign bigger power contracts, and the entire [trillion-dollar AI infrastructure race](/startups/ai-trillion-dollar-race-may-2026) gets another tank of fuel. The model might flop; the spending still lands in the same suppliers' pockets.
...
It's the same dynamic I broke down in [how open-source AI companies turn 'free' into billions](/tools/open-source-ai-models). Meta isn't trying to sell you Muse Spark. It's trying to make sure nobody else can charge much for a model either — which pressures the pricing of every paid model, accelerating the [price war Google already kicked off with Gemini](/tools/google-io-2026-gemini-35-flash-price-war). For you, the downstream effect is wonderful: the frontier keeps getting cheaper.
...
The honest risk is that throwing $135 billion at a problem doesn't guarantee you solve it. Money buys chips and talent, but it doesn't buy the research breakthroughs or the product taste that put OpenAI and Anthropic ahead in the first place. Meta could spend all of it and still ship the third-best model — and this time there's no renaming the company to hide it. There's also the brutal possibility I keep flagging from [the Gartner data on AI returns](/b2b/ai-layoffs-no-roi-gartner-paradox-2026): spend can create the *appearance* of progress without the ROI. Watch whether Muse Spark actually closes the gap on real benchmarks, or just closes it on the press release.

## What this means for you

Let me make it practical, depending on where you sit.

**If you build with AI**, Meta's strategy is a gift. A capable, likely-free, open-weight model from a company spending $135 billion to make it good means your underlying costs keep falling. You can run open models on your own infrastructure with no per-token API bill, which is exactly the kind of leverage that makes [a one-person company viable today](/startups/glean-7-billion-enterprise-ai-reads-your-company-2026). Watch Muse Spark's license terms closely — if it's as open as Llama was, it's a serious free tool in your kit.

**If you invest**, the read is nuanced. Meta spending $135 billion is unambiguously bullish for the suppliers — NVIDIA, power companies, data-center builders. It's more complicated for Meta itself: the market will eventually demand to see that this colossal spend produces real returns, the exact pressure I described in [the Gartner data on AI ROI](/b2b/ai-layoffs-no-roi-gartner-paradox-2026). And it's quietly bearish for pure-play model startups, because when a giant gives away a competitive model for free, it's hard to charge for yours. The lens for judging all of it is in [how VCs price AI companies in 2026](/vc/ai-startup-valuations-2025-2026).
